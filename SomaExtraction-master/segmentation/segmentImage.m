...
segm = eliminateComp(segm,THR3);
filledSegmentedImage1 = eliminateComp(filledSegmentedImage1,THR3);
filledSegmentedImage2 = eliminateComp(filledSegmentedImage2,THR3);
