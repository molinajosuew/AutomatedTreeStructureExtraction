...
% Load image and produce symmetrix extension
% xin=double(imread('MicroGlia_1.tif'));
load Boat256
xin=xo;
xau=cat(2,xin,fliplr(xin));
xau=cat(1,xau,flipdim(xau,1));
x=xau(1:512,1:512);
sigma=20
% Load image
...
imwrite(xr,'MicroGlia_Sh_r8.gif');
imwrite(x,'MicroGlia_symm.gif');
