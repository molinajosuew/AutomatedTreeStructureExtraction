...
function [mask, soma]=fastMarching_rect(detectedSoma,segmentation, filled_segmentation,filtersize,num_direction)
...
[dirRatio_burcins, firstSomaParts] = SomaDetection(segmentation,filled_segmentation,num_direction,filtersize); 

map=dirRatio_burcins./20;
for i = 1:CC.compNum
...
THR=10; %to fill possible gaps in soma region
