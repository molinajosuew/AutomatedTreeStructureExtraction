function [D,S,Q] = perform_fast_marchingnew(W, start_points, end_points, options)
...
if d==2
   ...
   % else
    ...
    %end
elseif d==3
    [D,S,Q] = perform_front_propagation_3d(W,start_points,end_points,nb_iter_max, H, L, values);
end
Q = Q+1;
